...
export const ProductSection = ({ productName, className }: ProductSectionProps) => {
  // Enhanced inclusions with grouped structure
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="space-y-6">
              {inclusionsData.map((group, groupIndex) => (
                <div key={groupIndex}>
                  <h4 className="h4-heading text-foreground">{group.title}</h4>
                  ...
                  {groupIndex < inclusionsData.length - 1 && (
                    <div className="mt-4 border-b border-wireframe-divider opacity-30"></div>
                  )}
                </div>
              ))}
            </div>
