...
export const KeyFindingsSection = ({ variant = "default", layout = "full" }: KeyFindingsSectionProps) => {
  const showPeopleSection = variant !== "elevated";
  const isNarrow = layout === "narrow";

  // Narrow layout: 2 columns max, Full layout: 3 columns
  const gridCols = isNarrow ? "md:grid-cols-2" : "md:grid-cols-3";
  const investmentSpan = isNarrow ? "md:col-span-2" : "md:col-span-2";
          ...
          <div className="col-span-12">
            ...
            <div className="space-y-10">
              ...
              <section>
                ...
                <div className={`grid grid-cols-1 gap-6 ${isNarrow ? '' : gridCols}`}>
                  <article className={`${isNarrow ? '' : investmentSpan} flex flex-col justify-between rounded-xl border border-border bg-background p-6 shadow-sm`}>
