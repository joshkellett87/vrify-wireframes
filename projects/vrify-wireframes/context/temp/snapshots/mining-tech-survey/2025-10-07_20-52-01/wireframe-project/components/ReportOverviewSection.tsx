...
export const ReportOverviewSection = ({ layout = "full" }: ReportOverviewSectionProps) => {
  // Narrow layout: stack cards vertically, full layout: use 3-column grid
      ...
      <div className="wireframe-container">
        <div className="wireframe-grid">
          <div className="col-span-12">
            ...
            <div className={`mt-8 grid grid-cols-1 gap-6 ${isNarrow ? '' : 'md:grid-cols-3'}`}>
              <div className={`grid gap-6 grid-cols-1 ${isNarrow ? '' : 'md:col-span-2 md:grid-cols-2'}`}>
